...
function Particles(gl, shader, alphaShader, world) {
    const particle1 = [];
    const particle1Box = new BoxTex(gl, shader, "bullet").setAdditive();
    const blood1 = [];
    const blood2 = [];
    ...
    const particle2 = [];
    const particle2Box = new BoxTex(gl, shader, "particle").setAdditive();
    ...
    this.bloodCheckWalls = function() {
        for (const i of blood1) i.checkWalls(world);
        for (const i of blood2) i.checkWalls(world);
    }
